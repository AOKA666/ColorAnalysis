...
const questions = [
  ...
  },
  {
    ...
    layout: "hair",
    options: [
      ["Black", "deep-cool", photoVisual(quizPhotoSprites.hair, 4, 2, 0, 0, "3 / 4")],
      ["Dark brown", "deep", photoVisual(quizPhotoSprites.hair, 4, 2, 1, 0, "3 / 4")],
      ["Medium brown", "medium-warm", photoVisual(quizPhotoSprites.hair, 4, 2, 2, 0, "3 / 4")],
      ["Light brown", "medium-warm", photoVisual(quizPhotoSprites.hair, 4, 2, 3, 0, "3 / 4")],
      ["Red / Auburn", "warm", photoVisual(quizPhotoSprites.hair, 4, 2, 0, 1, "3 / 4")],
      ["Dark blonde", "medium-soft", photoVisual(quizPhotoSprites.hair, 4, 2, 1, 1, "3 / 4")],
      ["Blonde", "light-warm", photoVisual(quizPhotoSprites.hair, 4, 2, 2, 1, "3 / 4")],
      ["Light blonde", "light", photoVisual(quizPhotoSprites.hair, 4, 2, 3, 1, "3 / 4")]
    ]
  },
  {
    key: "veins",
...
function photoVisual(src, cols, rows, col, row, aspect = "1 / 1") {
  return {
    type: "photo",
    src,
    w: `${cols * 100}%`,
...
if (stage && continueButton && backButton && progress && counter) {
...
if (downloadReport && resultSection) {
...
const seasons = {
  spring: { label: "Spring color palette", title: "Warm, clear & sunlit", description: "Golden warmth comes alive in coral, daffodil, leaf green, warm aqua, honey, and poppy red.", colors: ["#ef786a", "#f6c64f", "#94b957", "#49aaa1", "#f5d59a", "#c95f56"] },
  summer: { label: "Summer color palette", title: "Cool, soft & airy", description: "Cool softness feels fresh in mint, pale sage, misty blue, lavender, rose pink, and pearl gray.", colors: ["#bfe7d1", "#a9c9aa", "#a9cdeb", "#c9b7df", "#e9aebc", "#cfd3d6"] },
  autumn: { label: "Autumn color palette", title: "Warm, earthy & muted", description: "Grounded warmth shows up in terracotta, camel, olive, moss, deep teal, and muted aubergine.", colors: ["#bf6b4a", "#d6a264", "#8d8f4f", "#687443", "#426d6a", "#72515f"] },
  winter: { label: "Winter color palette", title: "Cool, crisp & high contrast", description: "Cool clarity is strongest in black, icy white, sapphire, blue red, emerald, and violet.", colors: ["#111827", "#f4f7fb", "#1f4e9e", "#b5123f", "#007f6d", "#5b3f95"] }
};
